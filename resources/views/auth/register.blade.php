            ...
            <div class="modal-body p-5 pt-0">
                ...
                <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" name="email" class="form-control rounded-4" id="floatingEmail" placeholder="name@example.com" value={{old('email') ?? $emailPre}}>
                        <label for="floatingEmail">Email address</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" name="name" class="form-control rounded-4" id="floatingName" placeholder="Name" value="{{ old('name')}}">
                        <label for="floatingName">Name</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" name="lastName" class="form-control rounded-4" id="floatingLastName" placeholder="Last Name" value="{{ old('lastName')}}">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input class="form-check-input" type="checkbox" onclick="passwdFunction()" id="eye">
